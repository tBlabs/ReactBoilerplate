...
var FooComponent_1 = __webpack_require__(30);
var FooClass_1 = __webpack_require__(31);
console.log('Start');
var foo = new FooClass_1.Foo("bar");
axios_1.default.get('http://www.localhost:4444/todos/2').then(function (x) { return console.log(x.data); });
...
var FooComponent = /** @class */ (function (_super) {
    ...
    FooComponent.prototype.Button2ClickHandler = function (event) {
    ...
    FooComponent.prototype.HandleInputChange = function (event) {
        console.log(event);
